...
const ProjectInfo = () => {
  return (
    <div className='px-7.5 lg:px-20 xl:px-40 sm:px-9.5  pt-32 pb-15 min-h-screen flex flex-col gap-12 relative overflow-hidden' >
        <div className='flex flex-col  gap-5 '>
            ...
            <h1 className='text-[2.875rem] leading-12 tracking-tighter font-semibold font-display sm:text-6xl md:text-7xl md:leading-18 lg:text-[5.5rem] xl:text-[6.25rem] lg:leading-23'>A calmer way to <br/><span className='golditalic'>read the market.</span></h1>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3.5 max-w-300'>
