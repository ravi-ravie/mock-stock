    ...
    <div className='flex flex-col justify-between overflow-hidden  pb-10 relative min-h-screen main-padding font-mono' >
        <div className='flex flex-col gap-5 pt-0'>
            ...
            <div className='flex flex-col items-start font-sans gap-4'>
                <button className='bg-gold text-black flex w-[90%] justify-between py-3 px-3.5 tracking-[1.5px] rounded items-center hover:-translate-y-1 duration-200 text-xs'>Explore markets <RiArrowRightUpLongFill size={14}/></button>
                <button className='flex  justify-between py-3 px-3.5 tracking-[1.5px] rounded items-center w-[90%] border border-white/20 hover:-translate-y-1 duration-200 hover:bg-white/8 text-xs'>How it works <RiPlayFill size={14} color="rgba(215,174,103,1)" /></button>
            </div>
        </div>
