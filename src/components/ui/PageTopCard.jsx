...
const PageTopCard = (props) => {
  return (
    <div className='border border-white/11 px-5 pt-6 pb-8.75 mb-6 bg-[#1c1d1e]/36'>
        ...
        <h1 className='font-display font-semibold  text-[2.75rem] sm:text-[3.85rem] lg:text-[4.65rem] mb-1 whitespace-nowrap'>{props.title}<span className='golditalic'> market</span></h1>
