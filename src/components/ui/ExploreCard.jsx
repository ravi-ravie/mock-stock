...
const ExploreCard = (props) => {
  return (
    <Link to={`/${props.asset.toLowerCase()}`}>
      <div className=' relative h-55 border border-white/11 bg-cover bg-center   bg-no-repeat overflow-hidden transition-all duration-250 hover:-translate-y-1.25 hover:border-gold/55 hover:shadow-[0_16px_30px_rgba(0,0,0,0.23)]' 
